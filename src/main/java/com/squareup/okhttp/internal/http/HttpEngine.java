...
public final class HttpEngine {
  ...
  public HttpEngine(OkHttpClient client, Request request, boolean bufferRequestBody,
    ...
    this.accesslogBuilder = new Accesslog.Builder();
  ...
  private void connect() throws IOException {
    ...
    accesslogBuilder.setConn(System.currentTimeMillis() - startConnectMills);
    accesslogBuilder.setDns(routeSelector.getDnsTimeMills());
  ...
  private Response readNetworkResponse() throws IOException {
    ...
    try {
      Accesslog accesslog = accesslogBuilder
          ...
          .setRelViaProxy(getRelViaProxy())
          .setCname(route.getAddress().getCNAME())
  ...
  private String getRelViaProxy() {
    return Accesslog.Builder.getRelViaProxy(
        route.getAddress().useWSCNAME(), 
        route.getAddress().getSslSocketFactory() != null, 
        route.getProxy().type() != Proxy.Type.DIRECT, 
        route.getCNCConnctionSpec().isHttpTohttps());
  }
}
