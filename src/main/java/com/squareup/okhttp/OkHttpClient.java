...
public class OkHttpClient implements Cloneable {
  ...
  static {
    Internal.instance = new Internal() {
      ...
      public void addAccesslog(Accesslog accesslog) {
        if (MaaPlus.singleton != null) {
          MaaPlus.singleton.addAccesslog(accesslog);
        }
      }
  ...
  private boolean httpTohttpsEnabled = false;
  ...
  private OkHttpClient(OkHttpClient okHttpClient) {
    ...
    this.httpTohttpsEnabled = okHttpClient.httpTohttpsEnabled;
  }
  ...
  void setHttpToHttpsEnabled(boolean enabled) {
    httpTohttpsEnabled = enabled;
  }
  
  public boolean isHttpToHttpsEnabled() {
