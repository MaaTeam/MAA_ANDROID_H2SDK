...
#define PACKAGE_STRING "nghttp2 1.6.0"
...
/* Hint to the compiler that a function parameters is not use
   AC_DEFINE([NGHTTP2_NORETURN], , [Hint to the compiler that a function never
   return]) d */
