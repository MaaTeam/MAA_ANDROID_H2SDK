...
public final class Route {
  ...
  final CNCConnectionSpec cncConnectSpec;

  public Route(Address address, Proxy proxy, InetSocketAddress inetSocketAddress,
      ConnectionSpec connectionSpec, CNCConnectionSpec cncConnectpSpec) {
    this(address, proxy, inetSocketAddress, connectionSpec,
        false /* shouldSendTlsFallbackIndicator */, cncConnectpSpec);
  }

  public Route(Address address, Proxy proxy, InetSocketAddress inetSocketAddress,
      ConnectionSpec connectionSpec, boolean shouldSendTlsFallbackIndicator,
      CNCConnectionSpec cncConnectpSpec) {
    if (address == null) {
    ...
    if (cncConnectpSpec == null) {
      throw new NullPointerException("cncConnectpSpec == null");
    }
    ...
    this.cncConnectSpec = cncConnectpSpec;
  }
  ...
  public CNCConnectionSpec getCNCConnctionSpec() {
    return cncConnectSpec;
  }
  ...
  @Override public boolean equals(Object obj) {
    if (obj instanceof Route) {
      ...
      return address.equals(other.address)
          ...
          && cncConnectSpec.equals(other.cncConnectSpec);
    }
    return false;
  }
