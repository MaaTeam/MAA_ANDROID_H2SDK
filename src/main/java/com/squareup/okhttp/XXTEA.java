...
public class XXTEA {
	...
	public static String encrypt(String data, String key) {
		...
		try {
			byte[] result;
			result = encrypt(data.getBytes(CHARSET), key.getBytes(CHARSET));
	...
	public static String decrypt(String data, String key) {
		...
		try {
			byte[] byteArrayData = Base64.decode(data, Base64.NO_WRAP);
			byte[] result = decrypt(byteArrayData, key.getBytes(CHARSET));
