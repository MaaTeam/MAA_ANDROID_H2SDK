 ...
 */
static inline void __list_add(struct list_head_t *new_node,
 ...
 */
static inline void list_add(struct list_head_t *new_node, struct list_head_t *head)
{
 ...
 */
static inline void list_add_tail(struct list_head_t *new_node, struct list_head_t *head)
{
 ...
 * @List:	the list
 * Iterate over list of given type, free all elements. 
 */
#define list_clear(Type, List)     \
  {                                  \
    Type *pos, *n = NULL;            \
