...
include F<libev_config.h> and configure itself accordingly.
...
keeps libev from including F<libev_config.h>, and it also defines dummy
...
F<ev.c>'s idea of where to find the F<libev_config.h> file, similarly to
C<EV_H>, above.
...
that everybody includes and which overrides some configure choices:
   ...
   #define EV_CONFIG_H <libev_config.h>
...
of F<ev.h>:
   ...
   #define EV_STANDALONE              /* keeps ev from requiring libev_config.h */
